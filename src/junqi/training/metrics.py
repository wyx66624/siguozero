    ...
    def log(self, update: int, values: Mapping[str, float | int | str]) -> None:
        ...
        compact = {
            ...
            in {
                ...
                "loss/critic_total",
                "critic/value_mse",
                "ppo/raw_nonzero_advantage_fraction",
                "ppo/no_advantage_signal",
                "critic/rollout_target_std",
                "critic/rollout_explained_variance",
                "critic/rollout_explained_variance_defined",
